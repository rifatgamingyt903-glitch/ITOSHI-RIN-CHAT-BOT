...
module.exports = {
  config: {
    ...
    countDown: 10,
    role: 0,
    shortDescription: "Find your love pair ❤️",
    longDescription: "Randomly matches you with someone from the group of opposite gender.",
    category: "love",
    guide: "{pn}"
  },
  ...
  onStart: async function ({ api, event, usersData }) {
    try {
      ...
      // Avatars
      drawCircle(ctx, myAvatar, 385, 40, 170);
      drawCircle(ctx, matchAvatar, width - 213, 190, 170);
